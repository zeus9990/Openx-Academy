...
embed_list = [
    discord.Embed(
        ...
        "• Answer 5 multiple-choice questions in this chapter.\n"
    ...
    discord.Embed(
        title="📋 Chapter 3: Introduction to Model Layer",
        description=(
            "Explore how containerized AI models are hosted on Xnodes, while smart contracts govern licensing, access control, and monetization, empowering permissionless, transparent and fair model usage. This creates a truly decentralized AI compute layer where models operate in a trustless, verifiable manner.\n\n"
            ">>> **How to attend the test:**\n"
            "• Answer 5 multiple-choice questions in this chapter.\n"
            "• Each question has a strict one-minute time limit.\n"
            "• Successfully pass all questions to earn an exclusive role that unlocks the next academy level.\n"
        ...
        url="https://i.postimg.cc/SsSBGzLk/OpenxAi_Academy_-_LEVEL_3.png"
    )
